...
author: |
  | Mykola Chuprynskyy
  | m.chuprynskyy@students.uu.nl
  | http://www.github.com/Floksy10
date: April 2023
urlcolor: purple
linkcolor: purple 
output: 
...
#The mean of countries that had no revolutions have a mean almost 2 times higher than the mean of countries that had at least one revolution. the medium growth of countries that did not have revolutions is almost 20% higher than the medium growth in countries with at least one revolution
...
The biggest factor driving economic development, according to the model summaries supplied, seems to be the variable "education." In all models (1, 2, 3, and 4), this variable consistently exhibits a statistically significant positive connection with economic growth. The coefficients for "education" are highly correlated with economic development at the 0.001 level (***). Other factors, such as "treatmore than 0," "rgdp60," and "tradeshare," may not always show statistically significant impacts or have a lower correlation with economic growth.
